...
namespace MetaDslx.Languages.Soal.Syntax.InternalSyntax
{
	...
	internal class OperationHeadGreen : SoalGreenNode
	{
	    ...
	    public OperationHeadGreen(SoalSyntaxKind kind, AnnotationListGreen annotationList, OperationResultGreen operationResult, NameGreen name, InternalSyntaxToken tOpenParen, ParameterListGreen parameterList, InternalSyntaxToken tCloseParen, InternalSyntaxToken kThrows, ThrowsListGreen throwsList)
	        : base(kind, null, null)
	    {
			if (annotationList != null)
			{
	    ...
	    public OperationHeadGreen(SoalSyntaxKind kind, AnnotationListGreen annotationList, OperationResultGreen operationResult, NameGreen name, InternalSyntaxToken tOpenParen, ParameterListGreen parameterList, InternalSyntaxToken tCloseParen, InternalSyntaxToken kThrows, ThrowsListGreen throwsList, DiagnosticInfo[] diagnostics, SyntaxAnnotation[] annotations)
	        : base(kind, diagnostics, annotations)
	    {
			if (annotationList != null)
			{
	    ...
	    public override GreenNode WithDiagnostics(DiagnosticInfo[] diagnostics)
	    {
	        return new OperationHeadGreen(this.Kind, this.annotationList, this.operationResult, this.name, this.tOpenParen, this.parameterList, this.tCloseParen, this.kThrows, this.throwsList, diagnostics, this.GetAnnotations());
	    }
	
	    public override GreenNode WithAnnotations(SyntaxAnnotation[] annotations)
	    {
	        return new OperationHeadGreen(this.Kind, this.annotationList, this.operationResult, this.name, this.tOpenParen, this.parameterList, this.tCloseParen, this.kThrows, this.throwsList, this.GetDiagnostics(), annotations);
	    }
	
	    public OperationHeadGreen Update(AnnotationListGreen annotationList, OperationResultGreen operationResult, NameGreen name, InternalSyntaxToken tOpenParen, ParameterListGreen parameterList, InternalSyntaxToken tCloseParen, InternalSyntaxToken kThrows, ThrowsListGreen throwsList)
	    {
	        if (this.annotationList != annotationList ||
				this.operationResult != operationResult ||
				this.name != name ||
				...
				this.throwsList != throwsList)
	        {
	            GreenNode newNode = SoalLanguage.Instance.InternalSyntaxFactory.OperationHead(annotationList, operationResult, name, tOpenParen, parameterList, tCloseParen, kThrows, throwsList);
	            var diags = this.GetDiagnostics();
	            if (diags != null && diags.Length > 0)
	               newNode = newNode.WithDiagnostics(diags);
	            var annotations = this.GetAnnotations();
	...
	internal class ThrowsListGreen : SoalGreenNode
	{
	    private InternalSeparatedSyntaxNodeList throwsException;
	
	    public ThrowsListGreen(SoalSyntaxKind kind, InternalSeparatedSyntaxNodeList throwsException)
	        : base(kind, null, null)
	    {
			if (throwsException != null)
			{
				this.AdjustFlagsAndWidth(throwsException);
				this.throwsException = throwsException;
			}
	    }
	
	    public ThrowsListGreen(SoalSyntaxKind kind, InternalSeparatedSyntaxNodeList throwsException, DiagnosticInfo[] diagnostics, SyntaxAnnotation[] annotations)
	        : base(kind, diagnostics, annotations)
	    {
			if (throwsException != null)
			{
	    ...
	    public InternalSeparatedSyntaxNodeList ThrowsException { get { return this.throwsException; } }
	
	    public override SyntaxNode CreateRed(SyntaxNode parent, int position)
	    {
	        return new global::MetaDslx.Languages.Soal.Syntax.ThrowsListSyntax(this, parent, position);
	    }
	    ...
	    public override GreenNode WithDiagnostics(DiagnosticInfo[] diagnostics)
	    {
	        return new ThrowsListGreen(this.Kind, this.throwsException, diagnostics, this.GetAnnotations());
	    }
	
	    public override GreenNode WithAnnotations(SyntaxAnnotation[] annotations)
	    {
	        return new ThrowsListGreen(this.Kind, this.throwsException, this.GetDiagnostics(), annotations);
	    }
	
	    public ThrowsListGreen Update(InternalSeparatedSyntaxNodeList throwsException)
	    {
	        if (this.throwsException != throwsException)
	        {
	            GreenNode newNode = SoalLanguage.Instance.InternalSyntaxFactory.ThrowsList(throwsException);
	            var diags = this.GetDiagnostics();
	            if (diags != null && diags.Length > 0)
	               newNode = newNode.WithDiagnostics(diags);
	            var annotations = this.GetAnnotations();
	...
	internal class ThrowsExceptionGreen : SoalGreenNode
	{
	    private QualifierGreen qualifier;
	
	    public ThrowsExceptionGreen(SoalSyntaxKind kind, QualifierGreen qualifier)
	        : base(kind, null, null)
	    {
			if (qualifier != null)
			{
	    ...
	    public ThrowsExceptionGreen(SoalSyntaxKind kind, QualifierGreen qualifier, DiagnosticInfo[] diagnostics, SyntaxAnnotation[] annotations)
	        : base(kind, diagnostics, annotations)
	    {
			if (qualifier != null)
			{
	    ...
	    public override SyntaxNode CreateRed(SyntaxNode parent, int position)
	    {
	        return new global::MetaDslx.Languages.Soal.Syntax.ThrowsExceptionSyntax(this, parent, position);
	    }
	    ...
	    public override GreenNode WithDiagnostics(DiagnosticInfo[] diagnostics)
	    {
	        return new ThrowsExceptionGreen(this.Kind, this.qualifier, diagnostics, this.GetAnnotations());
	    }
	
	    public override GreenNode WithAnnotations(SyntaxAnnotation[] annotations)
	    {
	        return new ThrowsExceptionGreen(this.Kind, this.qualifier, this.GetDiagnostics(), annotations);
	    }
	
	    public ThrowsExceptionGreen Update(QualifierGreen qualifier)
	    {
	        if (this.qualifier != qualifier)
	        {
	            GreenNode newNode = SoalLanguage.Instance.InternalSyntaxFactory.ThrowsException(qualifier);
	            var diags = this.GetDiagnostics();
	            if (diags != null && diags.Length > 0)
	               newNode = newNode.WithDiagnostics(diags);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
				return (ThrowsExceptionGreen)newNode;
	        }
	        return this;
	    }
	}
	...
	internal class SoalGreenFactory : InternalSyntaxFactory
	{
		...
		public OperationHeadGreen OperationHead(AnnotationListGreen annotationList, OperationResultGreen operationResult, NameGreen name, InternalSyntaxToken tOpenParen, ParameterListGreen parameterList, InternalSyntaxToken tCloseParen, InternalSyntaxToken kThrows, ThrowsListGreen throwsList, bool errorNode = false)
	    {
	#if DEBUG
			if (!errorNode)
			{
	...
	#endif
	        return new OperationHeadGreen(SoalSyntaxKind.OperationHead, annotationList, operationResult, name, tOpenParen, parameterList, tCloseParen, kThrows, throwsList);
	    }
		...
		public ThrowsListGreen ThrowsList(InternalSeparatedSyntaxNodeList throwsException, bool errorNode = false)
	    {
	#if DEBUG
			if (!errorNode)
			{
	...
	#endif
			int hash;
			var cached = SyntaxNodeCache.TryGetNode((int)SoalSyntaxKind.ThrowsList, throwsException, out hash);
			if (cached != null) return (ThrowsListGreen)cached;
			var result = new ThrowsListGreen(SoalSyntaxKind.ThrowsList, throwsException);
			if (hash >= 0)
			{
				SyntaxNodeCache.AddNode(result, hash);
			}
		...
		public ThrowsExceptionGreen ThrowsException(QualifierGreen qualifier, bool errorNode = false)
	    {
	#if DEBUG
			if (!errorNode)
			{
	...
	#endif
			int hash;
			var cached = SyntaxNodeCache.TryGetNode((int)SoalSyntaxKind.ThrowsException, qualifier, out hash);
			if (cached != null) return (ThrowsExceptionGreen)cached;
			var result = new ThrowsExceptionGreen(SoalSyntaxKind.ThrowsException, qualifier);
			if (hash >= 0)
			{
				SyntaxNodeCache.AddNode(result, hash);
			}
