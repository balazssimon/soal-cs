...
public partial class SoalParserBaseListener : ISoalParserListener {
	...
	/// <summary>
	/// Enter a parse tree produced by <see cref="SoalParser.throwsException"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void EnterThrowsException([NotNull] SoalParser.ThrowsExceptionContext context) { }
	/// <summary>
	/// Exit a parse tree produced by <see cref="SoalParser.throwsException"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void ExitThrowsException([NotNull] SoalParser.ThrowsExceptionContext context) { }
	/// <summary>
