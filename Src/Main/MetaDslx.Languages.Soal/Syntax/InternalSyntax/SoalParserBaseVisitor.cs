...
public partial class SoalParserBaseVisitor<Result> : AbstractParseTreeVisitor<Result>, ISoalParserVisitor<Result> {
	...
	/// <summary>
	/// Visit a parse tree produced by <see cref="SoalParser.throwsException"/>.
	/// <para>
	/// The default implementation returns the result of calling <see cref="AbstractParseTreeVisitor{Result}.VisitChildren(IRuleNode)"/>
	/// on <paramref name="context"/>.
	/// </para>
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	public virtual Result VisitThrowsException([NotNull] SoalParser.ThrowsExceptionContext context) { return VisitChildren(context); }
	/// <summary>
