...
namespace MetaDslx.Languages.Soal.Syntax
{
	...
	public sealed class OperationHeadSyntax : SoalSyntaxNode
	{
		...
		{ 
			get { return this.GetRed(ref this.throwsList, 7); } 
		}
	    ...
	    public override SyntaxNode GetNodeSlot(int index)
	    {
	        switch (index)
	        {
				...
				case 7: return this.GetRed(ref this.throwsList, 7);
				default: return null;
	        }
	    }
		...
		{
			return this.Update(AnnotationList, this.OperationResult, this.Name, this.TOpenParen, this.ParameterList, this.TCloseParen, this.KThrows, this.ThrowsList);
		}
	
	    public OperationHeadSyntax WithOperationResult(OperationResultSyntax operationResult)
		{
			return this.Update(this.AnnotationList, OperationResult, this.Name, this.TOpenParen, this.ParameterList, this.TCloseParen, this.KThrows, this.ThrowsList);
		}
	
	    public OperationHeadSyntax WithName(NameSyntax name)
		{
			return this.Update(this.AnnotationList, this.OperationResult, Name, this.TOpenParen, this.ParameterList, this.TCloseParen, this.KThrows, this.ThrowsList);
		}
	
	    public OperationHeadSyntax WithTOpenParen(SyntaxToken tOpenParen)
		{
			return this.Update(this.AnnotationList, this.OperationResult, this.Name, TOpenParen, this.ParameterList, this.TCloseParen, this.KThrows, this.ThrowsList);
		}
	
	    public OperationHeadSyntax WithParameterList(ParameterListSyntax parameterList)
		{
			return this.Update(this.AnnotationList, this.OperationResult, this.Name, this.TOpenParen, ParameterList, this.TCloseParen, this.KThrows, this.ThrowsList);
		}
	
	    public OperationHeadSyntax WithTCloseParen(SyntaxToken tCloseParen)
		{
			return this.Update(this.AnnotationList, this.OperationResult, this.Name, this.TOpenParen, this.ParameterList, TCloseParen, this.KThrows, this.ThrowsList);
		}
	
	    public OperationHeadSyntax WithKThrows(SyntaxToken kThrows)
		{
			return this.Update(this.AnnotationList, this.OperationResult, this.Name, this.TOpenParen, this.ParameterList, this.TCloseParen, KThrows, this.ThrowsList);
		}
	
	    public OperationHeadSyntax WithThrowsList(ThrowsListSyntax throwsList)
		{
			return this.Update(this.AnnotationList, this.OperationResult, this.Name, this.TOpenParen, this.ParameterList, this.TCloseParen, this.KThrows, ThrowsList);
		}
	
	    public OperationHeadSyntax Update(AnnotationListSyntax annotationList, OperationResultSyntax operationResult, NameSyntax name, SyntaxToken tOpenParen, ParameterListSyntax parameterList, SyntaxToken tCloseParen, SyntaxToken kThrows, ThrowsListSyntax throwsList)
	    {
	        if (this.AnnotationList != annotationList ||
	        ...
	        {
	            SyntaxNode newNode = SoalLanguage.Instance.SyntaxFactory.OperationHead(annotationList, operationResult, name, tOpenParen, parameterList, tCloseParen, kThrows, throwsList);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	{
	    private SeparatedSyntaxNodeList throwsException;
	
	    public ThrowsListSyntax(InternalSyntaxNode green, SyntaxTree syntaxTree, int position)
	        : base(green, syntaxTree, position)
	    {
	    }
	
	    public ThrowsListSyntax(InternalSyntaxNode green, SyntaxNode parent, int position)
	        : base(green, parent, position)
	    {
	    }
	
	    public SeparatedSyntaxNodeList<ThrowsExceptionSyntax> ThrowsException 
		{ 
			get
			{
				var red = this.GetRed(ref this.throwsException, 0);
				if (red != null)
				{
					return new SeparatedSyntaxNodeList<ThrowsExceptionSyntax>(red);
				}
				return null;
			} 
		}
	    ...
	    public override SyntaxNode GetNodeSlot(int index)
	    {
	        switch (index)
	        {
				case 0: return this.GetRed(ref this.throwsException, 0);
				default: return null;
	        }
	    }
	    ...
	    public override SyntaxNode GetCachedSlot(int index)
	    {
	        switch (index)
	        {
				case 0: return this.throwsException;
				default: return null;
	        }
	    }
	
	    public ThrowsListSyntax WithThrowsException(SeparatedSyntaxNodeList<ThrowsExceptionSyntax> throwsException)
		{
			return this.Update(ThrowsException);
		}
	
	    public ThrowsListSyntax AddThrowsException(params ThrowsExceptionSyntax[] throwsException)
		{
			return this.WithThrowsException(this.ThrowsException.AddRange(throwsException));
		}
	
	    public ThrowsListSyntax Update(SeparatedSyntaxNodeList<ThrowsExceptionSyntax> throwsException)
	    {
	        if (this.ThrowsException.Node != throwsException.Node)
	        {
	            SyntaxNode newNode = SoalLanguage.Instance.SyntaxFactory.ThrowsList(throwsException);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
	...
	public sealed class ThrowsExceptionSyntax : SoalSyntaxNode
	{
	    private QualifierSyntax qualifier;
	
	    public ThrowsExceptionSyntax(InternalSyntaxNode green, SyntaxTree syntaxTree, int position)
	        : base(green, syntaxTree, position)
	    {
	    }
	
	    public ThrowsExceptionSyntax(InternalSyntaxNode green, SyntaxNode parent, int position)
	        : base(green, parent, position)
	    {
	    }
	    ...
	    public ThrowsExceptionSyntax WithQualifier(QualifierSyntax qualifier)
		{
			return this.Update(Qualifier);
		}
	
	    public ThrowsExceptionSyntax Update(QualifierSyntax qualifier)
	    {
	        if (this.Qualifier != qualifier)
	        {
	            SyntaxNode newNode = SoalLanguage.Instance.SyntaxFactory.ThrowsException(qualifier);
	            var annotations = this.GetAnnotations();
	            if (annotations != null && annotations.Length > 0)
	               newNode = newNode.WithAnnotations(annotations);
				return (ThrowsExceptionSyntax)newNode;
	        }
	        return this;
	    }
	    ...
	    public override void Accept(ISoalSyntaxVisitor visitor)
	    {
	        visitor.VisitThrowsException(this);
	    }
	}
...
namespace MetaDslx.Languages.Soal
{
	...
	public interface ISoalSyntaxVisitor
	{
		...
		void VisitThrowsException(ThrowsExceptionSyntax node);
	...
	public class SoalSyntaxVisitor : SyntaxVisitor, ISoalSyntaxVisitor
	{
		...
		public virtual void VisitThrowsException(ThrowsExceptionSyntax node)
		{
		    this.DefaultVisit(node);
		}
	...
	public class SoalDetailedSyntaxVisitor : DetailedSyntaxVisitor, ISoalSyntaxVisitor
	{
		...
		public virtual void VisitThrowsList(ThrowsListSyntax node)
		{
			this.VisitList(node.ThrowsException);
		}
	...
	public interface ISoalSyntaxVisitor<TResult> 
	{
		...
		TResult VisitThrowsException(ThrowsExceptionSyntax node);
	...
	public class SoalSyntaxVisitor<TResult> : SyntaxVisitor<TResult>, ISoalSyntaxVisitor<TResult>
	{
		...
		public virtual TResult VisitThrowsException(ThrowsExceptionSyntax node)
		{
		    return this.DefaultVisit(node);
		}
	...
	public class SoalSyntaxRewriter : SyntaxRewriter, ISoalSyntaxVisitor<SyntaxNode>
	{
		...
		public virtual SyntaxNode VisitOperationHead(OperationHeadSyntax node)
		{
			...
			return node.Update(annotationList, operationResult, name, tOpenParen, parameterList, tCloseParen, kThrows, throwsList);
		}
		...
		{
		    var throwsException = this.VisitList(node.ThrowsException);
			return node.Update(throwsException);
		}
		
		public virtual SyntaxNode VisitThrowsException(ThrowsExceptionSyntax node)
		{
		    var qualifier = (QualifierSyntax)this.Visit(node.Qualifier);
			return node.Update(qualifier);
		}
	...
	public class SoalSyntaxFactory : SyntaxFactory
	{
		...
		public OperationHeadSyntax OperationHead(AnnotationListSyntax annotationList, OperationResultSyntax operationResult, NameSyntax name, SyntaxToken tOpenParen, ParameterListSyntax parameterList, SyntaxToken tCloseParen, SyntaxToken kThrows, ThrowsListSyntax throwsList)
		{
		    ...
		    if (throwsList == null) throw new ArgumentNullException(nameof(throwsList));
		    return (OperationHeadSyntax)SoalLanguage.Instance.InternalSyntaxFactory.OperationHead(annotationList == null ? null : (Syntax.InternalSyntax.AnnotationListGreen)annotationList.Green, (Syntax.InternalSyntax.OperationResultGreen)operationResult.Green, (Syntax.InternalSyntax.NameGreen)name.Green, (InternalSyntaxToken)tOpenParen.Green, parameterList == null ? null : (Syntax.InternalSyntax.ParameterListGreen)parameterList.Green, (InternalSyntaxToken)tCloseParen.Green, (InternalSyntaxToken)kThrows.Green, (Syntax.InternalSyntax.ThrowsListGreen)throwsList.Green).CreateRed();
		}
		
		public OperationHeadSyntax OperationHead(OperationResultSyntax operationResult, NameSyntax name, ThrowsListSyntax throwsList)
		{
			return this.OperationHead(null, operationResult, name, this.Token(SoalSyntaxKind.TOpenParen), null, this.Token(SoalSyntaxKind.TCloseParen), this.Token(SoalSyntaxKind.KThrows), throwsList);
		}
		...
		public ThrowsListSyntax ThrowsList(SeparatedSyntaxNodeList<ThrowsExceptionSyntax> throwsException)
		{
		    if (throwsException == null) throw new ArgumentNullException(nameof(throwsException));
		    return (ThrowsListSyntax)SoalLanguage.Instance.InternalSyntaxFactory.ThrowsList(throwsException.Green).CreateRed();
		}
		
		public ThrowsExceptionSyntax ThrowsException(QualifierSyntax qualifier)
		{
		    if (qualifier == null) throw new ArgumentNullException(nameof(qualifier));
		    return (ThrowsExceptionSyntax)SoalLanguage.Instance.InternalSyntaxFactory.ThrowsException((Syntax.InternalSyntax.QualifierGreen)qualifier.Green).CreateRed();
		}
