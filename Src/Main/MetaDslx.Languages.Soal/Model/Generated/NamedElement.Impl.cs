...
namespace MetaDslx.Languages.Soal.Symbols.__Impl
{
    ...
    internal class NamedElement_Impl : __MetaModelObject, NamedElement
    {
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                _baseTypes = __ImmutableArray.Create<__ModelClassInfo>(Soal.DocumentedElementInfo);
                _allBaseTypes = __ImmutableArray.Create<__ModelClassInfo>(Soal.DocumentedElementInfo);
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Soal.NamedElement_Name);
