...
namespace MetaDslx.Languages.Soal.Symbols.__Impl
{
    ...
    internal class EncodingBindingElement_Impl : __MetaModelObject, EncodingBindingElement
    {
        private EncodingBindingElement_Impl(string? id)
            : base(id)
        {
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            public override __MetaType MetaType => typeof(EncodingBindingElement);
            ...
            {
                var result = new EncodingBindingElement_Impl(id);
            ...
            {
                return "Soal.EncodingBindingElementInfo";
            }
        }
    }
}
