...
namespace MetaDslx.Languages.Soal.Symbols.__Impl
{
    ...
    internal class WsAddressingBindingElement_Impl : __MetaModelObject, WsAddressingBindingElement
    {
        private WsAddressingBindingElement_Impl(string? id)
            : base(id)
        {
            ...
            Soal.__CustomImpl.WsProtocolBindingElement(this);
            Soal.__CustomImpl.WsAddressingBindingElement(this);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                _baseTypes = __ImmutableArray.Create<__ModelClassInfo>(Soal.WsProtocolBindingElementInfo);
                _allBaseTypes = __ImmutableArray.Create<__ModelClassInfo>(Soal.WsProtocolBindingElementInfo, Soal.ProtocolBindingElementInfo, Soal.BindingElementInfo, Soal.NamedElementInfo, Soal.DocumentedElementInfo);
            ...
            public override __MetaType MetaType => typeof(WsAddressingBindingElement);
            ...
            {
                var result = new WsAddressingBindingElement_Impl(id);
            ...
            {
                return "Soal.WsAddressingBindingElementInfo";
            }
        }
    }
}
