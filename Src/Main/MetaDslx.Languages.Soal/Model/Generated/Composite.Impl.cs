...
namespace MetaDslx.Languages.Soal.Symbols.__Impl
{
    ...
    internal class Composite_Impl : __MetaModelObject, Composite
    {
        private Composite_Impl(string? id)
            : base(id)
        {
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                _baseTypes = __ImmutableArray.Create<__ModelClassInfo>(Soal.ComponentInfo);
                _allBaseTypes = __ImmutableArray.Create<__ModelClassInfo>(Soal.ComponentInfo, Soal.SoalTypeInfo, Soal.DeclarationInfo, Soal.AnnotatedElementInfo, Soal.NamedElementInfo, Soal.DocumentedElementInfo);
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Soal.Composite_Components, Soal.Composite_Wires);
            ...
            public override __MetaType MetaType => typeof(Composite);
            ...
            {
                var result = new Composite_Impl(id);
