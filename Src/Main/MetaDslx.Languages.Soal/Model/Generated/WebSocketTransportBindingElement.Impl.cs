...
namespace MetaDslx.Languages.Soal.Symbols.__Impl
{
    ...
    internal class WebSocketTransportBindingElement_Impl : __MetaModelObject, WebSocketTransportBindingElement
    {
        private WebSocketTransportBindingElement_Impl(string? id)
            : base(id)
        {
            ...
            Soal.__CustomImpl.WebSocketTransportBindingElement(this);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            public override __MetaType MetaType => typeof(WebSocketTransportBindingElement);
            ...
            {
                var result = new WebSocketTransportBindingElement_Impl(id);
            ...
            {
                return "Soal.WebSocketTransportBindingElementInfo";
            }
        }
    }
}
