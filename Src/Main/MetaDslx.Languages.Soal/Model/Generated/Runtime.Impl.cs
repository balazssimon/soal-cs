...
namespace MetaDslx.Languages.Soal.Symbols.__Impl
{
    ...
    internal class Runtime_Impl : __MetaModelObject, Runtime
    {
        private Runtime_Impl(string? id)
            : base(id)
        {
            Soal.__CustomImpl.DocumentedElement(this);
            Soal.__CustomImpl.NamedElement(this);
            Soal.__CustomImpl.Runtime(this);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            public override __MetaType MetaType => typeof(Runtime);
            ...
            {
                var result = new Runtime_Impl(id);
