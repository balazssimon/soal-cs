...
namespace MetaDslx.Languages.Soal.Symbols.__Impl
{
    ...
    internal class Enum_Impl : __MetaModelObject, Enum
    {
        private Enum_Impl(string? id)
            : base(id)
        {
            ...
            Soal.__CustomImpl.Enum(this);
        }
    
        public override __ModelClassInfo MInfo => __Info.Instance;
    
        public MetaDslx.Languages.Soal.Symbols.Enum BaseType
        {
            get => MGet<MetaDslx.Languages.Soal.Symbols.Enum>(Soal.Enum_BaseType);
            set => MSet<MetaDslx.Languages.Soal.Symbols.Enum>(Soal.Enum_BaseType, value);
        }
    
        public global::MetaDslx.Modeling.ICollectionSlot<MetaDslx.Languages.Soal.Symbols.EnumLiteral> EnumLiterals
        {
            get => MGetCollection<EnumLiteral>(Soal.Enum_EnumLiterals);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Soal.Enum_BaseType, Soal.Enum_EnumLiterals);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Soal.Enum_BaseType, Soal.Enum_EnumLiterals, Soal.Declaration_FullName, Soal.Declaration_Namespace, Soal.AnnotatedElement_Annotations, Soal.NamedElement_Name, Soal.DocumentedElement_Documentation);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Soal.Enum_BaseType, Soal.Enum_EnumLiterals, Soal.Declaration_FullName, Soal.Declaration_Namespace, Soal.AnnotatedElement_Annotations, Soal.NamedElement_Name, Soal.DocumentedElement_Documentation);
                var publicPropertiesByName = __ImmutableDictionary.CreateBuilder<string, __ModelProperty>();
                publicPropertiesByName.Add("BaseType", Soal.Enum_BaseType);
                publicPropertiesByName.Add("EnumLiterals", Soal.Enum_EnumLiterals);
                ...
                modelPropertyInfos.Add(Soal.Enum_BaseType, new __ModelPropertyInfo(new __ModelPropertySlot(Soal.Enum_BaseType, __ImmutableArray.Create<__ModelProperty>(Soal.Enum_BaseType), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Soal.Enum_EnumLiterals, new __ModelPropertyInfo(new __ModelPropertySlot(Soal.Enum_EnumLiterals, __ImmutableArray.Create<__ModelProperty>(Soal.Enum_EnumLiterals), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(Soal.EnumLiteral_Enum), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
            ...
            public override __MetaType MetaType => typeof(Enum);
