...
namespace MetaDslx.Languages.Soal.Symbols.__Impl
{
    ...
    internal class Annotation_Impl : __MetaModelObject, Annotation
    {
            ...
            : base(id)
        {
            ...
            Soal.__CustomImpl.Annotation(this);
        }
    
        public override __ModelClassInfo MInfo => __Info.Instance;
    
        public global::MetaDslx.Modeling.ICollectionSlot<MetaDslx.Languages.Soal.Symbols.AnnotationProperty> Properties
        {
            get => MGetCollection<AnnotationProperty>(Soal.Annotation_Properties);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Soal.Annotation_Properties);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Soal.Annotation_Properties, Soal.NamedElement_Name, Soal.DocumentedElement_Documentation);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Soal.Annotation_Properties, Soal.NamedElement_Name, Soal.DocumentedElement_Documentation);
                var publicPropertiesByName = __ImmutableDictionary.CreateBuilder<string, __ModelProperty>();
                publicPropertiesByName.Add("Properties", Soal.Annotation_Properties);
                ...
                modelPropertyInfos.Add(Soal.Annotation_Properties, new __ModelPropertyInfo(new __ModelPropertySlot(Soal.Annotation_Properties, __ImmutableArray.Create<__ModelProperty>(Soal.Annotation_Properties), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
