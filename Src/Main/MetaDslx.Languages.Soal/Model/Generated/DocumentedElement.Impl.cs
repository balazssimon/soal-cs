...
namespace MetaDslx.Languages.Soal.Symbols.__Impl
{
    ...
    internal class DocumentedElement_Impl : __MetaModelObject, DocumentedElement
    {
        private DocumentedElement_Impl(string? id)
            : base(id)
        {
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Soal.DocumentedElement_Documentation);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Soal.DocumentedElement_Documentation);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Soal.DocumentedElement_Documentation);
                ...
                _declaredOperations = __ImmutableArray.Create<__ModelOperation>(Soal.DocumentedElement_GetDocumentationLines);
            ...
            public override __MetaType MetaType => typeof(DocumentedElement);
            ...
            {
                var result = new DocumentedElement_Impl(id);
            ...
            {
                return "Soal.DocumentedElementInfo";
            }
        }
    }
}
