...
namespace MetaDslx.Languages.Soal.Symbols.__Impl
{
    ...
    internal class WsProtocolBindingElement_Impl : __MetaModelObject, WsProtocolBindingElement
    {
        private WsProtocolBindingElement_Impl(string? id)
            : base(id)
        {
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                _baseTypes = __ImmutableArray.Create<__ModelClassInfo>(Soal.ProtocolBindingElementInfo);
                _allBaseTypes = __ImmutableArray.Create<__ModelClassInfo>(Soal.ProtocolBindingElementInfo, Soal.BindingElementInfo, Soal.NamedElementInfo, Soal.DocumentedElementInfo);
            ...
            public override __MetaType MetaType => typeof(WsProtocolBindingElement);
            ...
            {
                var result = new WsProtocolBindingElement_Impl(id);
            ...
            {
                return "Soal.WsProtocolBindingElementInfo";
            }
        }
    }
}
