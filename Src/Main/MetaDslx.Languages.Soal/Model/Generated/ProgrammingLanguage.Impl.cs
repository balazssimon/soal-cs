...
namespace MetaDslx.Languages.Soal.Symbols.__Impl
{
    ...
    internal class ProgrammingLanguage_Impl : __MetaModelObject, ProgrammingLanguage
    {
        private ProgrammingLanguage_Impl(string? id)
            : base(id)
        {
            Soal.__CustomImpl.DocumentedElement(this);
            Soal.__CustomImpl.NamedElement(this);
            Soal.__CustomImpl.ProgrammingLanguage(this);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            public override __MetaType MetaType => typeof(ProgrammingLanguage);
            ...
            {
                var result = new ProgrammingLanguage_Impl(id);
            ...
            {
                return "Soal.ProgrammingLanguageInfo";
            }
        }
    }
}
