...
namespace MetaDslx.Languages.Soal.Symbols.__Impl
{
    ...
    internal class ArrayType_Impl : __MetaModelObject, ArrayType
    {
        private ArrayType_Impl(string? id)
            : base(id)
        {
            ...
            Soal.__CustomImpl.ArrayType(this);
        }
        ...
        {
            get => MGet<MetaDslx.Languages.Soal.Symbols.SoalType>(Soal.ArrayType_InnerType);
            set => MSet<MetaDslx.Languages.Soal.Symbols.SoalType>(Soal.ArrayType_InnerType, value);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Soal.ArrayType_InnerType);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Soal.ArrayType_InnerType, Soal.Declaration_FullName, Soal.Declaration_Namespace, Soal.AnnotatedElement_Annotations, Soal.NamedElement_Name, Soal.DocumentedElement_Documentation);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Soal.ArrayType_InnerType, Soal.Declaration_FullName, Soal.Declaration_Namespace, Soal.AnnotatedElement_Annotations, Soal.NamedElement_Name, Soal.DocumentedElement_Documentation);
                var publicPropertiesByName = __ImmutableDictionary.CreateBuilder<string, __ModelProperty>();
                publicPropertiesByName.Add("InnerType", Soal.ArrayType_InnerType);
            ...
            public override __MetaType MetaType => typeof(ArrayType);
            ...
            {
                var result = new ArrayType_Impl(id);
