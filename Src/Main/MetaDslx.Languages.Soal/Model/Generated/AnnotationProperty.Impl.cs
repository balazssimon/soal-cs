...
namespace MetaDslx.Languages.Soal.Symbols.__Impl
{
    ...
    internal class AnnotationProperty_Impl : __MetaModelObject, AnnotationProperty
    {
        private AnnotationProperty_Impl(string? id)
            : base(id)
        {
            Soal.__CustomImpl.DocumentedElement(this);
            Soal.__CustomImpl.NamedElement(this);
            Soal.__CustomImpl.AnnotationProperty(this);
        }
        ...
        public object Value
        {
            get => MGet<object>(Soal.AnnotationProperty_Value);
            set => MSet<object>(Soal.AnnotationProperty_Value, value);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Soal.AnnotationProperty_Value);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Soal.AnnotationProperty_Value, Soal.NamedElement_Name, Soal.DocumentedElement_Documentation);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Soal.AnnotationProperty_Value, Soal.NamedElement_Name, Soal.DocumentedElement_Documentation);
                var publicPropertiesByName = __ImmutableDictionary.CreateBuilder<string, __ModelProperty>();
                publicPropertiesByName.Add("Value", Soal.AnnotationProperty_Value);
                ...
                modelPropertyInfos.Add(Soal.AnnotationProperty_Value, new __ModelPropertyInfo(new __ModelPropertySlot(Soal.AnnotationProperty_Value, __ImmutableArray.Create<__ModelProperty>(Soal.AnnotationProperty_Value), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ValueType | __ModelPropertyFlags.BuiltInType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
            ...
            public override __MetaType MetaType => typeof(AnnotationProperty);
            ...
            {
                var result = new AnnotationProperty_Impl(id);
            ...
            {
                return "Soal.AnnotationPropertyInfo";
            }
        }
    }
}
