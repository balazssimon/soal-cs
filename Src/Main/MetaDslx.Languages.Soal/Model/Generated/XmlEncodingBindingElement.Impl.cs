...
namespace MetaDslx.Languages.Soal.Symbols.__Impl
{
    ...
    internal class XmlEncodingBindingElement_Impl : __MetaModelObject, XmlEncodingBindingElement
    {
        private XmlEncodingBindingElement_Impl(string? id)
            : base(id)
        {
            ...
            Soal.__CustomImpl.XmlEncodingBindingElement(this);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            public override __MetaType MetaType => typeof(XmlEncodingBindingElement);
            ...
            {
                var result = new XmlEncodingBindingElement_Impl(id);
            ...
            {
                return "Soal.XmlEncodingBindingElementInfo";
            }
        }
    }
}
