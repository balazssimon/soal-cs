...
namespace MetaDslx.Languages.Soal.Symbols.__Impl
{
    ...
    internal class RestTransportBindingElement_Impl : __MetaModelObject, RestTransportBindingElement
    {
        private RestTransportBindingElement_Impl(string? id)
            : base(id)
        {
            ...
            Soal.__CustomImpl.RestTransportBindingElement(this);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            public override __MetaType MetaType => typeof(RestTransportBindingElement);
            ...
            {
                var result = new RestTransportBindingElement_Impl(id);
            ...
            {
                return "Soal.RestTransportBindingElementInfo";
            }
        }
    }
}
