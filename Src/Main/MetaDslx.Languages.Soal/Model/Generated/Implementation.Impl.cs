...
namespace MetaDslx.Languages.Soal.Symbols.__Impl
{
    ...
    internal class Implementation_Impl : __MetaModelObject, Implementation
    {
        private Implementation_Impl(string? id)
            : base(id)
        {
            Soal.__CustomImpl.DocumentedElement(this);
            Soal.__CustomImpl.NamedElement(this);
            Soal.__CustomImpl.Implementation(this);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            public override __MetaType MetaType => typeof(Implementation);
            ...
            {
                var result = new Implementation_Impl(id);
            ...
            {
                return "Soal.ImplementationInfo";
            }
        }
    }
}
