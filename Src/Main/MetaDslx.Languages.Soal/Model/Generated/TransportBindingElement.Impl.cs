...
namespace MetaDslx.Languages.Soal.Symbols.__Impl
{
    ...
    internal class TransportBindingElement_Impl : __MetaModelObject, TransportBindingElement
    {
        private TransportBindingElement_Impl(string? id)
            : base(id)
        {
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            public override __MetaType MetaType => typeof(TransportBindingElement);
            ...
            {
                var result = new TransportBindingElement_Impl(id);
            ...
            {
                return "Soal.TransportBindingElementInfo";
            }
        }
    }
}
