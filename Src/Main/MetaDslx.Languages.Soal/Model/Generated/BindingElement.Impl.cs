...
namespace MetaDslx.Languages.Soal.Symbols.__Impl
{
    ...
    internal class BindingElement_Impl : __MetaModelObject, BindingElement
    {
        private BindingElement_Impl(string? id)
            : base(id)
        {
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            public override __MetaType MetaType => typeof(BindingElement);
            ...
            {
                var result = new BindingElement_Impl(id);
            ...
            {
                return "Soal.BindingElementInfo";
            }
        }
    }
}
