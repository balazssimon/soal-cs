...
namespace MetaDslx.Languages.Soal.Symbols.__Impl
{
    ...
    internal class Deployment_Impl : __MetaModelObject, Deployment
    {
            ...
            : base(id)
        {
            ...
            Soal.__CustomImpl.Deployment(this);
        }
    
        public override __ModelClassInfo MInfo => __Info.Instance;
    
        public global::MetaDslx.Modeling.ICollectionSlot<MetaDslx.Languages.Soal.Symbols.Environment> Environments
        {
            get => MGetCollection<Environment>(Soal.Deployment_Environments);
        }
    
        public global::MetaDslx.Modeling.ICollectionSlot<MetaDslx.Languages.Soal.Symbols.Wire> Wires
        {
            get => MGetCollection<Wire>(Soal.Deployment_Wires);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Soal.Deployment_Environments, Soal.Deployment_Wires);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Soal.Deployment_Environments, Soal.Deployment_Wires, Soal.Declaration_FullName, Soal.Declaration_Namespace, Soal.AnnotatedElement_Annotations, Soal.NamedElement_Name, Soal.DocumentedElement_Documentation);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Soal.Deployment_Environments, Soal.Deployment_Wires, Soal.Declaration_FullName, Soal.Declaration_Namespace, Soal.AnnotatedElement_Annotations, Soal.NamedElement_Name, Soal.DocumentedElement_Documentation);
                var publicPropertiesByName = __ImmutableDictionary.CreateBuilder<string, __ModelProperty>();
                publicPropertiesByName.Add("Environments", Soal.Deployment_Environments);
                publicPropertiesByName.Add("Wires", Soal.Deployment_Wires);
                ...
                modelPropertyInfos.Add(Soal.Deployment_Environments, new __ModelPropertyInfo(new __ModelPropertySlot(Soal.Deployment_Environments, __ImmutableArray.Create<__ModelProperty>(Soal.Deployment_Environments), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Soal.Deployment_Wires, new __ModelPropertyInfo(new __ModelPropertySlot(Soal.Deployment_Wires, __ImmutableArray.Create<__ModelProperty>(Soal.Deployment_Wires), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
