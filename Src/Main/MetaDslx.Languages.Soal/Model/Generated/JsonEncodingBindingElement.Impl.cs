...
namespace MetaDslx.Languages.Soal.Symbols.__Impl
{
    ...
    internal class JsonEncodingBindingElement_Impl : __MetaModelObject, JsonEncodingBindingElement
    {
        private JsonEncodingBindingElement_Impl(string? id)
            : base(id)
        {
            ...
            Soal.__CustomImpl.JsonEncodingBindingElement(this);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            public override __MetaType MetaType => typeof(JsonEncodingBindingElement);
            ...
            {
                var result = new JsonEncodingBindingElement_Impl(id);
            ...
            {
                return "Soal.JsonEncodingBindingElementInfo";
            }
        }
    }
}
