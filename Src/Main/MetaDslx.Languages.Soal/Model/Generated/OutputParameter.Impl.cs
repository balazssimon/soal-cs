...
namespace MetaDslx.Languages.Soal.Symbols.__Impl
{
    ...
    internal class OutputParameter_Impl : __MetaModelObject, OutputParameter
    {
        private OutputParameter_Impl(string? id)
            : base(id)
        {
            Soal.__CustomImpl.TypedElement(this);
            Soal.__CustomImpl.AnnotatedElement(this);
            Soal.__CustomImpl.OutputParameter(this);
        }
        ...
        {
            get => MGet<bool>(Soal.OutputParameter_IsOneway);
            set => MSet<bool>(Soal.OutputParameter_IsOneway, value);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                _baseTypes = __ImmutableArray.Create<__ModelClassInfo>(Soal.AnnotatedElementInfo, Soal.TypedElementInfo);
                _allBaseTypes = __ImmutableArray.Create<__ModelClassInfo>(Soal.AnnotatedElementInfo, Soal.TypedElementInfo);
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Soal.OutputParameter_IsOneway);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Soal.OutputParameter_IsOneway, Soal.AnnotatedElement_Annotations, Soal.TypedElement_Type);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Soal.OutputParameter_IsOneway, Soal.AnnotatedElement_Annotations, Soal.TypedElement_Type);
                var publicPropertiesByName = __ImmutableDictionary.CreateBuilder<string, __ModelProperty>();
                publicPropertiesByName.Add("IsOneway", Soal.OutputParameter_IsOneway);
            ...
            public override __MetaType MetaType => typeof(OutputParameter);
            ...
            {
                var result = new OutputParameter_Impl(id);
            ...
            {
                return "Soal.OutputParameterInfo";
            }
        }
    }
}
