...
namespace MetaDslx.Languages.Soal.Symbols.__Impl
{
    ...
    internal class Namespace_Impl : __MetaModelObject, Namespace
    {
            ...
            : base(id)
        {
            ...
            Soal.__CustomImpl.Namespace(this);
        }
    
        public override __ModelClassInfo MInfo => __Info.Instance;
    
        public global::MetaDslx.Modeling.ICollectionSlot<MetaDslx.Languages.Soal.Symbols.Declaration> Declarations
        {
            get => MGetCollection<Declaration>(Soal.Namespace_Declarations);
        }
    
        public string? Prefix
        {
            get => MGet<string?>(Soal.Namespace_Prefix);
            set => MSet<string?>(Soal.Namespace_Prefix, value);
        }
    
        public string? Uri
        {
            get => MGet<string?>(Soal.Namespace_Uri);
            set => MSet<string?>(Soal.Namespace_Uri, value);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Soal.Namespace_Declarations, Soal.Namespace_Prefix, Soal.Namespace_Uri);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Soal.Namespace_Declarations, Soal.Namespace_Prefix, Soal.Namespace_Uri, Soal.Declaration_FullName, Soal.Declaration_Namespace, Soal.AnnotatedElement_Annotations, Soal.NamedElement_Name, Soal.DocumentedElement_Documentation);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Soal.Namespace_Declarations, Soal.Namespace_Prefix, Soal.Namespace_Uri, Soal.Declaration_FullName, Soal.Declaration_Namespace, Soal.AnnotatedElement_Annotations, Soal.NamedElement_Name, Soal.DocumentedElement_Documentation);
                var publicPropertiesByName = __ImmutableDictionary.CreateBuilder<string, __ModelProperty>();
                publicPropertiesByName.Add("Declarations", Soal.Namespace_Declarations);
                publicPropertiesByName.Add("Prefix", Soal.Namespace_Prefix);
                publicPropertiesByName.Add("Uri", Soal.Namespace_Uri);
                ...
                modelPropertyInfos.Add(Soal.Namespace_Declarations, new __ModelPropertyInfo(new __ModelPropertySlot(Soal.Namespace_Declarations, __ImmutableArray.Create<__ModelProperty>(Soal.Namespace_Declarations), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(Soal.Declaration_Namespace), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Soal.Namespace_Prefix, new __ModelPropertyInfo(new __ModelPropertySlot(Soal.Namespace_Prefix, __ImmutableArray.Create<__ModelProperty>(Soal.Namespace_Prefix), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ValueType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.BuiltInType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Soal.Namespace_Uri, new __ModelPropertyInfo(new __ModelPropertySlot(Soal.Namespace_Uri, __ImmutableArray.Create<__ModelProperty>(Soal.Namespace_Uri), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ValueType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.BuiltInType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
