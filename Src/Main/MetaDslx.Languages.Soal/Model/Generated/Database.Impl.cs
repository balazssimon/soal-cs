...
namespace MetaDslx.Languages.Soal.Symbols.__Impl
{
    ...
    internal class Database_Impl : __MetaModelObject, Database
    {
        private Database_Impl(string? id)
            : base(id)
        {
            ...
            Soal.__CustomImpl.Database(this);
        }
    
        public override __ModelClassInfo MInfo => __Info.Instance;
    
        public global::MetaDslx.Modeling.ICollectionSlot<MetaDslx.Languages.Soal.Symbols.Struct> Entities
        {
            get => MGetCollection<Struct>(Soal.Database_Entities);
        }
    
        public global::MetaDslx.Modeling.ICollectionSlot<MetaDslx.Languages.Soal.Symbols.Operation> Operations
        {
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                _baseTypes = __ImmutableArray.Create<__ModelClassInfo>(Soal.InterfaceInfo);
                _allBaseTypes = __ImmutableArray.Create<__ModelClassInfo>(Soal.InterfaceInfo, Soal.SoalTypeInfo, Soal.DeclarationInfo, Soal.AnnotatedElementInfo, Soal.NamedElementInfo, Soal.DocumentedElementInfo);
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Soal.Database_Entities);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Soal.Database_Entities, Soal.Interface_Operations, Soal.Declaration_FullName, Soal.Declaration_Namespace, Soal.AnnotatedElement_Annotations, Soal.NamedElement_Name, Soal.DocumentedElement_Documentation);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Soal.Database_Entities, Soal.Interface_Operations, Soal.Declaration_FullName, Soal.Declaration_Namespace, Soal.AnnotatedElement_Annotations, Soal.NamedElement_Name, Soal.DocumentedElement_Documentation);
                var publicPropertiesByName = __ImmutableDictionary.CreateBuilder<string, __ModelProperty>();
                publicPropertiesByName.Add("Entities", Soal.Database_Entities);
            ...
            public override __MetaType MetaType => typeof(Database);
            ...
            {
                var result = new Database_Impl(id);
