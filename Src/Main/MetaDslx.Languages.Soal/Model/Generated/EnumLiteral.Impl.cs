...
namespace MetaDslx.Languages.Soal.Symbols.__Impl
{
    ...
    internal class EnumLiteral_Impl : __MetaModelObject, EnumLiteral
    {
        ...
        public MetaDslx.Languages.Soal.Symbols.Enum Enum
        {
            get => MGet<MetaDslx.Languages.Soal.Symbols.Enum>(Soal.EnumLiteral_Enum);
            set => MSet<MetaDslx.Languages.Soal.Symbols.Enum>(Soal.EnumLiteral_Enum, value);
        }
        ...
        public MetaDslx.Languages.Soal.Symbols.SoalType Type
        {
            get => MGet<MetaDslx.Languages.Soal.Symbols.SoalType>(Soal.TypedElement_Type);
            set => MSet<MetaDslx.Languages.Soal.Symbols.SoalType>(Soal.TypedElement_Type, value);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                _baseTypes = __ImmutableArray.Create<__ModelClassInfo>(Soal.AnnotatedElementInfo, Soal.NamedElementInfo, Soal.TypedElementInfo);
                _allBaseTypes = __ImmutableArray.Create<__ModelClassInfo>(Soal.AnnotatedElementInfo, Soal.NamedElementInfo, Soal.DocumentedElementInfo, Soal.TypedElementInfo);
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Soal.EnumLiteral_Enum);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Soal.EnumLiteral_Enum, Soal.AnnotatedElement_Annotations, Soal.NamedElement_Name, Soal.DocumentedElement_Documentation, Soal.TypedElement_Type);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Soal.EnumLiteral_Enum, Soal.AnnotatedElement_Annotations, Soal.NamedElement_Name, Soal.DocumentedElement_Documentation, Soal.TypedElement_Type);
                ...
                modelPropertyInfos.Add(Soal.EnumLiteral_Enum, new __ModelPropertyInfo(new __ModelPropertySlot(Soal.EnumLiteral_Enum, __ImmutableArray.Create<__ModelProperty>(Soal.EnumLiteral_Enum, Soal.TypedElement_Type), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(Soal.Enum_EnumLiterals), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Soal.TypedElement_Type), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                ...
                modelPropertyInfos.Add(Soal.TypedElement_Type, new __ModelPropertyInfo(new __ModelPropertySlot(Soal.EnumLiteral_Enum, __ImmutableArray.Create<__ModelProperty>(Soal.EnumLiteral_Enum, Soal.TypedElement_Type), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(Soal.EnumLiteral_Enum), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
