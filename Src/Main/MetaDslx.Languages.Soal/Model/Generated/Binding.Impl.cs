...
namespace MetaDslx.Languages.Soal.Symbols.__Impl
{
    ...
    internal class Binding_Impl : __MetaModelObject, Binding
    {
        private Binding_Impl(string? id)
            : base(id)
        {
            ...
            Soal.__CustomImpl.Binding(this);
        }
    
        public override __ModelClassInfo MInfo => __Info.Instance;
    
        public global::MetaDslx.Modeling.ICollectionSlot<MetaDslx.Languages.Soal.Symbols.EncodingBindingElement> Encodings
        {
            get => MGetCollection<EncodingBindingElement>(Soal.Binding_Encodings);
        }
    
        public global::MetaDslx.Modeling.ICollectionSlot<MetaDslx.Languages.Soal.Symbols.ProtocolBindingElement> Protocols
        {
            get => MGetCollection<ProtocolBindingElement>(Soal.Binding_Protocols);
        }
    
        public MetaDslx.Languages.Soal.Symbols.TransportBindingElement Transport
        {
            get => MGet<MetaDslx.Languages.Soal.Symbols.TransportBindingElement>(Soal.Binding_Transport);
            set => MSet<MetaDslx.Languages.Soal.Symbols.TransportBindingElement>(Soal.Binding_Transport, value);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Soal.Binding_Encodings, Soal.Binding_Protocols, Soal.Binding_Transport);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Soal.Binding_Encodings, Soal.Binding_Protocols, Soal.Binding_Transport, Soal.Declaration_FullName, Soal.Declaration_Namespace, Soal.AnnotatedElement_Annotations, Soal.NamedElement_Name, Soal.DocumentedElement_Documentation);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Soal.Binding_Encodings, Soal.Binding_Protocols, Soal.Binding_Transport, Soal.Declaration_FullName, Soal.Declaration_Namespace, Soal.AnnotatedElement_Annotations, Soal.NamedElement_Name, Soal.DocumentedElement_Documentation);
                var publicPropertiesByName = __ImmutableDictionary.CreateBuilder<string, __ModelProperty>();
                publicPropertiesByName.Add("Encodings", Soal.Binding_Encodings);
                publicPropertiesByName.Add("Protocols", Soal.Binding_Protocols);
                publicPropertiesByName.Add("Transport", Soal.Binding_Transport);
                ...
                modelPropertyInfos.Add(Soal.Binding_Encodings, new __ModelPropertyInfo(new __ModelPropertySlot(Soal.Binding_Encodings, __ImmutableArray.Create<__ModelProperty>(Soal.Binding_Encodings), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Soal.Binding_Protocols, new __ModelPropertyInfo(new __ModelPropertySlot(Soal.Binding_Protocols, __ImmutableArray.Create<__ModelProperty>(Soal.Binding_Protocols), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.NullableType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Collection), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
                modelPropertyInfos.Add(Soal.Binding_Transport, new __ModelPropertyInfo(new __ModelPropertySlot(Soal.Binding_Transport, __ImmutableArray.Create<__ModelProperty>(Soal.Binding_Transport), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Containment | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
            ...
            public override __MetaType MetaType => typeof(Binding);
            ...
            {
                var result = new Binding_Impl(id);
