...
namespace MetaDslx.Languages.Soal.Symbols.__Impl
{
    ...
    internal class SoalType_Impl : __MetaModelObject, SoalType
    {
        private SoalType_Impl(string? id)
            : base(id)
        {
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Soal.Declaration_FullName, Soal.Declaration_Namespace, Soal.AnnotatedElement_Annotations, Soal.NamedElement_Name, Soal.DocumentedElement_Documentation);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Soal.Declaration_FullName, Soal.Declaration_Namespace, Soal.AnnotatedElement_Annotations, Soal.NamedElement_Name, Soal.DocumentedElement_Documentation);
            ...
            public override __MetaType MetaType => typeof(SoalType);
            ...
            {
                var result = new SoalType_Impl(id);
