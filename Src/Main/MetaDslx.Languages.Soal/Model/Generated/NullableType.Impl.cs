...
namespace MetaDslx.Languages.Soal.Symbols.__Impl
{
    ...
    internal class NullableType_Impl : __MetaModelObject, NullableType
    {
        private NullableType_Impl(string? id)
            : base(id)
        {
            ...
            Soal.__CustomImpl.NullableType(this);
        }
    
        public override __ModelClassInfo MInfo => __Info.Instance;
    
        public MetaDslx.Languages.Soal.Symbols.SoalType InnerType
        {
            get => MGet<MetaDslx.Languages.Soal.Symbols.SoalType>(Soal.NullableType_InnerType);
            set => MSet<MetaDslx.Languages.Soal.Symbols.SoalType>(Soal.NullableType_InnerType, value);
        }
        ...
        internal class __Info : __ModelClassInfo
        {
            ...
            private __Info() 
            {
                ...
                _declaredProperties = __ImmutableArray.Create<__ModelProperty>(Soal.NullableType_InnerType);
                _allDeclaredProperties = __ImmutableArray.Create<__ModelProperty>(Soal.NullableType_InnerType, Soal.Declaration_FullName, Soal.Declaration_Namespace, Soal.AnnotatedElement_Annotations, Soal.NamedElement_Name, Soal.DocumentedElement_Documentation);
                _publicProperties = __ImmutableArray.Create<__ModelProperty>(Soal.NullableType_InnerType, Soal.Declaration_FullName, Soal.Declaration_Namespace, Soal.AnnotatedElement_Annotations, Soal.NamedElement_Name, Soal.DocumentedElement_Documentation);
                var publicPropertiesByName = __ImmutableDictionary.CreateBuilder<string, __ModelProperty>();
                publicPropertiesByName.Add("InnerType", Soal.NullableType_InnerType);
                ...
                modelPropertyInfos.Add(Soal.NullableType_InnerType, new __ModelPropertyInfo(new __ModelPropertySlot(Soal.NullableType_InnerType, __ImmutableArray.Create<__ModelProperty>(Soal.NullableType_InnerType), default, __ModelPropertyFlags.None | __ModelPropertyFlags.ReferenceType | __ModelPropertyFlags.ModelObjectType | __ModelPropertyFlags.Single), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>(), __ImmutableArray.Create<__ModelProperty>()));
            ...
            public override __MetaType MetaType => typeof(NullableType);
            ...
            {
                var result = new NullableType_Impl(id);
